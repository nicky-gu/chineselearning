...
export default function DictationPracticePage() {
  ...
  async function checkAnswer() {
    const correctHanzi = hanziList[currentIndex].char
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  value={userHanzi}
                  onChange={(e) => setUserHanzi(e.target.value)}
                  onKeyPress={(e) => {
                  ...
                  {!isCorrect && (
                    <div className="text-center mt-2 space-y-1">
                      <div className="text-sm">
                        正确答案: <span className="text-2xl font-bold">{currentHanzi.char}</span>
                      </div>
                      <div className="text-sm text-gray-600">
                        拼音: {currentHanzi.pinyin}
                      </div>
                    </div>
                  )}
                </div>
